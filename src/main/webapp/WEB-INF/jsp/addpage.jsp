...
<body align="center">
	...
	<div>
		<table align="center">
			<tr>
				<th></th>
				<th colspan="2">Please fill below details, for others to contact you</th>
			</tr>
				<tr>
			...
			<tr>
				...
				<td colspan="2"><form:input path="name" placeholder="your name" maxlength="32"/></td>
			</tr>
			<tr>
				<td><form:label path="startPoint">Your Address</form:label></td>
				<td colspan="2"><form:input path="startPoint" id="address"/></td>
			</tr>
			<tr>
				<td><form:label path="contactNumber">Mobile Number </form:label></td>
				<td colspan="2"><form:input path="contactNumber" placeholder="your 10 digit number" maxlength="10"/></td>
			</tr>
			<tr>
				<td><form:label path="password">Select a Password</form:label></td>
				<td colspan="2"><form:input type="password" path="password" placeholder="select password" maxlength="15"/></td>
			</tr>
			<tr>
